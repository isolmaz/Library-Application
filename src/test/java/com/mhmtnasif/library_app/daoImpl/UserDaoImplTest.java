...
public class UserDaoImplTest {
    ...
    public void addUser() throws NoSuchAlgorithmException {
        ...
        assertFalse("addUser method failed the user's id who added should not be 0", addedUser.getId() == 0);
        assertSame("addUser method failed objects should be same", user , addedUser);
    }
